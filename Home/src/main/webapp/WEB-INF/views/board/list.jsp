      ...
      <div class="row">
	    <div class="col-md-3">
		    <div class="card p-3 p-3" style="width: 100%;">
			  <a href="/View?bno=${ board.bno }"><img src="/img/company1.png" class="card-img-top" alt="..."></a>
			  <div class="card-body">
      ...
      <div class="row">
	    ...
	    <div class="col-md-3">
		    <div class="card p-3 p-3" style="width: 100%;">
			  <a href="/View?bno=${ board.bno }"><img src="/img/company1.png" class="card-img-top" alt="..."></a>
			  <div class="card-body">
			    <h5 class="card-title"><a href="/View?bno=${ board.bno }" style="text-decoration: none;color: black;font-weight: bold;">${ board.title   }</a></h5>
			    <p class="card-text">주소</p>
			    <p class="card-text">전화번호</p>
			    <p class="card-text">전화번호</p>
			    <a href="/View?bno=${ board.bno }" class="btn btn-secondary">예약하기</a>
		  	  </div>
			</div>
		</div>
	    </c:forEach>
